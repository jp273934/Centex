        ...
        public IEnumerable<Panel> GetPanels()
        {
            var panels = new List<Panel>
            {
                ...
                new Panel
                {
                    ...
                    ImageDescription = "Image of a pallet rack"
                },
                new Panel
                {
                    Id = 2,
                    ...
                    ImageDescription = "Image of pioneer dock leveler"
                },
                new Panel
                {
                    Id = 3,
                    ...
                    ImageDescription = "Image of quantun wire shelving"
                },
                new Panel
                {
                    Id = 4,
                ...
                new Panel
                {
                    ...
                    ImageDescription = "Image of a mezzanie"
                }
            };
